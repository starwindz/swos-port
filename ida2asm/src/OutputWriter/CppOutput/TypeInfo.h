...
inline TypeInfo getTypeInfo(size_t size)
{
    ...
    switch (size) {
    case 1: return { "uint8_t", "int8_t", "int16_t", 8, "0x80", "INT8_MIN", "INT8_MAX" };
    case 2: return { "uint16_t", "int16_t", "int32_t", 16, "0x8000", "INT16_MIN", "INT16_MAX" };
    case 4: return { "uint32_t", "int32_t", "int64_t", 32, "0x80000000", "INT32_MIN", "INT32_MAX" };
