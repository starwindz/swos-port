...
const OutputItem *COutput::outputDataItem(const OutputItem *item, DataItemOutputFormat format, bool checkTableVar /* = false */)
{
    ...
    bool isSprite = outputDataItemType(dataItem, format, name, arraySize, isOffset);
...
bool COutput::outputDataItemType(const DataItem *dataItem, DataItemOutputFormat format, const String& name, size_t arraySize, bool isOffset)
{
    bool isSprite = false;
    ...
    if (instruction->type() == Token::T_MOV) {
        ...
        if (isOffset) {
            ...
            if (address->text() == kSwitchTableName) {
                ...
                static const std::string kSwitchLines[] = {
                    "switch ((word)D0) {",
