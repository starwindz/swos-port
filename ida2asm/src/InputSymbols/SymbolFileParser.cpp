...
static const char kHeader[] =
    ...
    "    template <typename T>\n"
    "    void assign(T t) {\n"
    "        if constexpr (std::is_convertible<T, dword>::value) {\n"
