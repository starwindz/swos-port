...
extern Player1StatusProcAllowed
extern Player2StatusProcAllowed
%ifdef DEBUG
extern EndLogFile
%endif
...
Player1StatusProcHook:
        calla Player1StatusProcAllowed
        mov  bx, 1
.test:
        test al, al
        jz   .abort
        cmp  word [g_joyKbdWord], bx
        retn
.abort:
        pop  eax
        retn

Player2StatusProcHook:
        calla Player2StatusProcAllowed
        mov  bx, 5
        jmp  Player1StatusProcHook.test
...
%endif
    ...
    ; ensure PlayerXStatusProc only gets called once per frame, or it will overwrite values used for teams update
    StartRecord Player1StatusProc
        calla Player1StatusProcHook
        nop
    EndRecord

    StartRecord Player2StatusProc
        calla Player2StatusProcHook
        nop
    EndRecord
